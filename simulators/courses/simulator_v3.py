...
class LearnerActivityEnv(gym.Env):
    ...
    def __init__(self, data, pre_score, num_activities, max_activities_per_user, max_steps):
    ...
    def step(self, action):
        ...
        # Update observation
        self.observation = np.insert(self.user_activities, 0, self.user_pre_score)
